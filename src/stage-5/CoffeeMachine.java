...
public class CoffeeMachine {
    ...
    private static boolean isEnough(String type, int water, int milk, int beans, int cups) {
    ...
    private static void remaining(int water,int milk,int coffeebeans,int cups,int money){
